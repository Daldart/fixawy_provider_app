...
import 'package:fixawy_provider/models/booking_status_response.dart';
import 'package:fixawy_provider/models/caregory_response.dart';
import 'package:fixawy_provider/models/city_list_response.dart';
import 'package:fixawy_provider/models/country_list_response.dart';
import 'package:fixawy_provider/models/dashboard_response.dart';
import 'package:fixawy_provider/models/document_list_response.dart';
import 'package:fixawy_provider/models/handyman_dashboard_response.dart';
import 'package:fixawy_provider/models/login_response.dart';
import 'package:fixawy_provider/models/notification_list_response.dart';
import 'package:fixawy_provider/models/payment_list_reasponse.dart';
import 'package:fixawy_provider/models/plan_list_response.dart';
import 'package:fixawy_provider/models/plan_request_model.dart';
import 'package:fixawy_provider/models/profile_update_response.dart';
import 'package:fixawy_provider/models/provider_document_list_response.dart';
import 'package:fixawy_provider/models/provider_info_model.dart';
import 'package:fixawy_provider/models/provider_subscription_model.dart';
import 'package:fixawy_provider/models/register_response.dart';
import 'package:fixawy_provider/models/search_list_response.dart';
import 'package:fixawy_provider/models/service_address_response.dart';
...
import 'package:fixawy_provider/models/service_response.dart';
import 'package:fixawy_provider/models/service_review_response.dart';
import 'package:fixawy_provider/models/state_list_response.dart';
import 'package:fixawy_provider/models/subscription_history_model.dart';
...
import 'package:fixawy_provider/models/user_info_response.dart';
import 'package:fixawy_provider/models/user_list_response.dart';
import 'package:fixawy_provider/models/user_type_response.dart';
import 'package:fixawy_provider/models/verify_transaction_response.dart';
...
import 'package:fixawy_provider/provider/jobRequest/models/post_job_response.dart';
...
void _performAdditionalProcessingProvider(DashboardResponse data) async {
  ...
  compareValuesInSharedPreference(
      IS_ADVANCE_PAYMENT_ALLOWED, data.isAdvancedPaymentAllowed == '1');
...
Future<List<BookingData>> getBookingList(int page,
  ...
  try {
    ...
    if (status == BOOKING_PAYMENT_STATUS_ALL) {
      var respose = await handleResponse(await buildHttpResponse(
          'booking-list?per_page=$perPage&page=$page$searchParam',
          method: HttpMethodType.GET));
      res = BookingListResponse.fromJson(respose);
    } else {
      var respose = await handleResponse(await buildHttpResponse(
...
// Future<List<BookingStatusModel>> getBookingByStatus({
//   String status = '',

// }) async {
//   try {
//     List<BookingStatusModel> bookingsList=[];
//     final response = await handleResponse(await buildHttpResponse(
//         'bookings/status?status=$status',
//         method: HttpMethodType.GET));
//    // bookingsList=BookingStatusModel.fromJson(response) as List<BookingStatusModel>;
//     response.map((json) => bookingsList.add(BookingStatusModel.fromJson(json))).toList();
...
Future<List<GooglePlacesModel>> getSuggestion(String input) async {
  ...
  String request =
      '$baseURL?input=$input&key=$GOOGLE_MAPS_API_KEY&sessiontoken=${appStore.token}';
