...
import 'package:fixawy_provider/components/disabled_rating_bar_widget.dart';
import 'package:fixawy_provider/components/handyman_name_widget.dart';
...
import 'package:fixawy_provider/screens/chat/user_chat_screen.dart';
                            ...
                            setState(() {
                              ...
                              if (widget.isCustomer) {
                                if (widget.customerData != null &&
                                    widget.customerData!.contactNumber
                                        .validate()
                                        .contains('+')) {
                                  phoneNumber =
                                      "${widget.customerData!.contactNumber.validate().replaceAll('-', '')}";
                                } else {
                                  phoneNumber =
                                      "+${widget.customerData!.contactNumber.validate().replaceAll('-', '')}";
                                }
